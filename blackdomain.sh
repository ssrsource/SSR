...
iptables -A OUTPUT -p udp -m string --hex-string "|05|nuomi|03|com" --algo bm --dport 53 -j DROP -m comment --comment "nuomi.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|07|zhaopin|03|com" --algo bm --dport 53 -j DROP -m comment --comment "zhaopin.com" 
...
iptables -A OUTPUT -p udp -m string --hex-string "|07|yizhibo|03|com" --algo bm --dport 53 -j DROP -m comment --comment "yizhibo.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|04|feng|03|com" --algo bm --dport 53 -j DROP -m comment --comment "feng.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|07|quanmin|02|tv" --algo bm --dport 53 -j DROP -m comment --comment "quanmin.tv" 
...
iptables -A OUTPUT -p udp -m string --hex-string "|06|kankan|03|com" --algo bm --dport 53 -j DROP -m comment --comment "kankan.com" 
...
iptables -A OUTPUT -p udp -m string --hex-string "|04|cctv|03|com" --algo bm --dport 53 -j DROP -m comment --comment "cctv.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|05|ifeng|03|com" --algo bm --dport 53 -j DROP -m comment --comment "ifeng.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|04|cntv|02|cn" --algo bm --dport 53 -j DROP -m comment --comment "cntv.cn" 
iptables -A OUTPUT -p udp -m string --hex-string "|09|pearvideo|03|com" --algo bm --dport 53 -j DROP -m comment --comment "pearvideo.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|08|kuaishou|03|com" --algo bm --dport 53 -j DROP -m comment --comment "kuaishou.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|08|ksapisrv|03|com" --algo bm --dport 53 -j DROP -m comment --comment "kuaishou.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|06|yximgs|03|com" --algo bm --dport 53 -j DROP -m comment --comment "kuaishou.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|07|gifshow|03|com" --algo bm --dport 53 -j DROP -m comment --comment "kuaishou.com" 
#bbs.misc
...
iptables -A OUTPUT -p udp -m string --hex-string "|06|youdao|03|com" --algo bm --dport 53 -j DROP -m comment --comment "youdao.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|08|ximalaya|03|com" --algo bm --dport 53 -j DROP -m comment --comment "ximalaya.com" 
iptables -A OUTPUT -p udp -m string --hex-string "|04|news|02|cn" --algo bm --dport 53 -j DROP -m comment --comment "news.cn" 
iptables -A OUTPUT -p udp -m string --hex-string "|06|people|03|com|02|cn" --algo bm --dport 53 -j DROP -m comment --comment "people.com.cn" 
iptables -A OUTPUT -p udp -m string --hex-string "|05|xycdn|03|com" --algo bm --dport 53 -j DROP -m comment --comment "xycdn.com" 
